"""About dialog for the Shani Cassini."""
...
class ShaniosAboutDialog(Gtk.AboutDialog):
    ...
    def _setup_dialog(self) -> None:
        ...
        self.set_program_name("Shani Cassini")
        self.set_version("0.1.0")
        self.set_copyright("© 2026 Shanios Developers")
        self.set_website("https://github.com/shani8dev/shani-cassini")
        ...
        # Set license
        license_text = """Shani Cassini is free software: you can redistribute it and/or modify
