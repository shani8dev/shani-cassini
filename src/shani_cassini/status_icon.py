"""System tray icon implementation for Shani Cassini."""
...
class StatusIcon:
    """System tray icon for Shani Cassini."""
    ...
    def _add_menu_items(self) -> None:
        ...
        if self._main_window:
            self._menu.append("Show Shani Cassini", "win.show")
            self._menu.append("Hide Shani Cassini", "win.hide")
    ...
    def _make_menu_handler(self, name: str):
        ...
        def _handler(_action, _parameter):
            if name == "show" and self._main_window:
                ...
                dialog.set_program_name("Shani Cassini")
